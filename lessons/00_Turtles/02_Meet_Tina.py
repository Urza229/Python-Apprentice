...
the program and try to understand what each line does.
      # Lift the pen up so we can move tina without drawing
tina.forward(20)          
...
tina.shape('human')                    # Set the shape of the turtle to a turtle
...
tina.penup()                                    # Move tina forward by 20
...
# the next file 03_Turtle_Tricks.python
